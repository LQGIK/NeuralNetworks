...
def get_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # Convolutional layer
        tf.keras.layers.Conv2D(
            150, kernel_size=(3, 3), activation="relu", strides=(1,1), padding="same", input_shape=(IMG_WIDTH, IMG_HEIGHT, 1)
        ),
...
def main():
    ...
    images, labels = load("FacialRecognition")
